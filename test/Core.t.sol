...
contract CoreTest is Test {
    ...
    function test_initializePool(address token0, address token1, uint128 fee, int32 tick, uint32 tickSpacing) public {
        ...
        PoolKey memory key =
            PoolKey({token0: token0, token1: token1, fee: fee, tickSpacing: tickSpacing, extension: address(0)});
