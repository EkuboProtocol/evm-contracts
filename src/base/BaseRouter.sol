...
/// @title Ekubo Protocol Base Router
/// @author Moody Salem <moody@ekubo.org>
/// @notice Base swap, quote, and settlement logic for Ekubo routers.
/// @dev Provides high-level swap functionality including single-hop, multi-hop, and batch swaps
abstract contract BaseRouter is UsesCore, PayableMulticallable, BaseLocker {
    ...
    /// @notice Constructs the base router contract.
    ...
    /// @param swaps Array of swap structs, each containing the route and initial token amount
